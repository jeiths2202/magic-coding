      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12" id="grades-container">
          {grades.map((grade, index) => (
            <div key={grade.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow card-hover">
              <div className="text-center">
                ...
                <button 
                  className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition-colors btn-animated"
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">📚 학습 특징</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl mb-2">🎯</div>
              <h4 className="font-semibold text-gray-800">단계별 난이도</h4>
              <p className="text-sm text-gray-600 mt-1">기초부터 고급까지 체계적 학습</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">📱</div>
              <h4 className="font-semibold text-gray-800">모바일 최적화</h4>
              <p className="text-sm text-gray-600 mt-1">스마트폰, 태블릿 완벽 지원</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">🎮</div>
              <h4 className="font-semibold text-gray-800">실습 중심</h4>
              <p className="text-sm text-gray-600 mt-1">게임과 프로젝트로 재미있게</p>
            </div>
            <div className="text-center">
              <div className="text-3xl mb-2">⭐</div>
              <h4 className="font-semibold text-gray-800">프리미엄 과정</h4>
              <p className="text-sm text-gray-600 mt-1">고급 기능과 개인 지도</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">기초 과정은 무료로 제공됩니다</p>
          <button 
